 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.init_declarator_listImpl#getInit_declarator_listR <em>Init declarator list R</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class init_declarator_listImpl extends MinimalEObjectImpl.Container implements init_declarator_list
{
  ...
  /**
   * The cached value of the '{@link #getInit_declarator_listR() <em>Init declarator list R</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected init_declarator_listR init_declarator_listR;
   ...
   * @generated
   */
  public init_declarator_listR getInit_declarator_listR()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetInit_declarator_listR(init_declarator_listR newInit_declarator_listR, NotificationChain msgs)
  {
    init_declarator_listR oldInit_declarator_listR = init_declarator_listR;
    init_declarator_listR = newInit_declarator_listR;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R, oldInit_declarator_listR, newInit_declarator_listR);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setInit_declarator_listR(init_declarator_listR newInit_declarator_listR)
  {
    if (newInit_declarator_listR != init_declarator_listR)
    {
      NotificationChain msgs = null;
      if (init_declarator_listR != null)
        msgs = ((InternalEObject)init_declarator_listR).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R, null, msgs);
      if (newInit_declarator_listR != null)
        msgs = ((InternalEObject)newInit_declarator_listR).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R, null, msgs);
      msgs = basicSetInit_declarator_listR(newInit_declarator_listR, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R, newInit_declarator_listR, newInit_declarator_listR));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R:
        return basicSetInit_declarator_listR(null, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R:
        return getInit_declarator_listR();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR:
        ...
        return;
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R:
        setInit_declarator_listR((init_declarator_listR)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR:
        ...
        return;
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R:
        setInit_declarator_listR((init_declarator_listR)null);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST_R:
        return init_declarator_listR != null;
    }

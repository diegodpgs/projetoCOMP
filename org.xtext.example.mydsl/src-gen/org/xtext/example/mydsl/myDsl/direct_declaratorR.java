...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>direct declarator R</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getRec <em>Rec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getType_qualifier_list <em>Type qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getParameter_type_list <em>Parameter type list</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getIdentifier_list <em>Identifier list</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_declaratorR()
 * @model
 * @generated
 */
public interface direct_declaratorR extends EObject
{
  /**
   * Returns the value of the '<em><b>Rec</b></em>' containment reference list.
   * The list contents are of type {@link org.xtext.example.mydsl.myDsl.direct_declaratorR}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_declaratorR_Rec()
   * @model containment="true"
   * @generated
   */
  EList<direct_declaratorR> getRec();
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_declaratorR_Type_qualifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getType_qualifier_list <em>Type qualifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_declaratorR_Assignment_expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getAssignment_expression <em>Assignment expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_declaratorR_Parameter_type_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getParameter_type_list <em>Parameter type list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getdirect_declaratorR_Identifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.direct_declaratorR#getIdentifier_list <em>Identifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
